...
@section('title') {{ config('app.name', 'Laravel') }} - Contact @endsection
...
@section('content')
  ...
  <div id="content"> 
            ...
            <div class="boxes-in">
              ...
              <ul class="location">
                ...
                <li> <i class="fa fa-envelope"></i>
                  <p>Support@dialmed.com</p>
                  <p>doctor@dialmed.com</p>
                </li>
    ...
    <section class="map-block margin-top-100">
      ...
      <div class="markers-wrapper addresses-block"> <a class="marker" data-rel="map-canvas" data-lat="-37.814199" data-lng="144.961560" data-string="DialMed Hospital"></a> </div>
    </section>
  </div>
@endsection